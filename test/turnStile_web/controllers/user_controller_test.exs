defmodule TurnStileWeb.UserControllerTest do
  use TurnStileWeb.ConnCase

  import TurnStile.PatientsFixtures

  @create_attrs %{email: "some email", first_name: "some first_name", health_card_num: 42, last_name: "some last_name", phone: "some phone"}
