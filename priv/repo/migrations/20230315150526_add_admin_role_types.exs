defmodule TurnStile.Repo.Migrations.AddAdminRoleTypes do
  ...
  def change do
      ...
      execute("create type admin_role_value as enum #{TurnStile.Utils.convert_to_parens_string(Enum.map(EmployeeRolesMap.get_permission_role_values(), fn {_key, value} -> value end))}")
