defmodule TurnStileWeb.Router do
  ...
  # if Mix.env() == :test do
    scope "/test" do
      ...
      post "/organizations/:id/employees/register", TurnStileWeb.TestController, :quick_register_employee
      # get("/", TurnStileWeb.TestController, :employee_register)
      get "/organizations/:id/employees/register", TurnStileWeb.TestController, :employee_register_page
    end
  # end
  ...
  scope "/", TurnStileWeb do
    ...
    live(
      "/organizations/:organization_id/employees/:employee_id/users/:id/edit",
      UserLive.Index,
      :edit
    )

    live(
      "/organizations/:organization_id/employees/:employee_id/users/:user_id",
      UserLive.Show,
      :show
    )
  end
